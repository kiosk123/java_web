...
public class ApplicationContext {
	...
	/*외부에서 생성한 SqlSessionFactory를 등록할 수 있게 addBean 메서드를 추가했다*/
	public void addBean(String name,Object obj){
		objTable.put(name, obj);
	}
	
	public void prepareObjectByAnnotion(String basePackage)throws Exception{
	...
	private  Object findObjectByType(Class<?> type)throws Exception{
